    ...
    this.find = function(options, cbk) {
        ...
        (function(rf, op, cb) {
            ...
            rf.root.getFile(rf.fileName, null, function(f) {
                ...
                console.log(' -----> collection find: getFile 1 ok');
                f.file(function(data) {
                        //alert('collection find: getFile 2 ok');
                        console.log(' -----> collection find: getFile 2 ok');
                        ...
                        myreader.onload = function(e) {
                            ...
                            if(e.target.result == null) {
                                ...
                                console.log(' -----> collection find: res null');
                                cb('no data error', null);
                            }
                            if(e.target.result.length == 0) {
                                console.log(' -----> collection find: res 0');
                                cb('no data error', null);
                            }
                            ...
                            console.log(' -----> collection find: return res');
                            cb(null, res);
                        }
                        myreader.onerror = function(e) {
                            console.log(' -----> collection find: read error!!!');
                            cb('error', null);
                        }
                        myreader.readAsText(data);
                    },
                    function(err){
                        console.log(' -----> collection find: getFile 2 error');
                    }
                );
            });
        })(this, options, cbk);
                        ...
                        myreader.onload = function(e) {
                            ...
                            rf.fileHandle.createWriter(function (writer){
                                    ...
                                    writer.onwriteend = function(e) {
                                        console.log(' -----> collection insert: file written!');
                                        cb(null, null);
                                    };
                                    writer.write(bb);
                                },
                                function(err) {
                                    console.log(' -----> collection insert: writer error');
                                }
                            );
                        }
                        myreader.onerror = function(e) {
                            console.log(' -----> collection insert: read error!!!');
                            cb('error', null);
                        }
                        myreader.readAsText(data);
                    },
